...
const RaceList = ({ races, setRace = () => { }, creation = false }) => {
    ...
    return (<>
        <div test-id='racesArr' className={Races_module_css_1.default.container}>

        {races.map((e) => (<RaceDetail_1.default key={e.id} creation={creation} click={handleClick} desc={e.description} name={e.name}></RaceDetail_1.default>))}
        </div>
